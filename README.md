...
[![Source version](https://img.shields.io/badge/version-0.2.1rc3-blue.svg)](https://pypi.org/project/yylo-ledger/)
...
```bash
python -m pip install 'yylo-ledger==0.2.1rc3'
yylo-ledger --version
```

The `0.2.1rc3` source/tag is a prerelease; it is not the stable install. Pin exact versions in automation.
